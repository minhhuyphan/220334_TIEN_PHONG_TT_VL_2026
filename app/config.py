...
class Settings:
    ...
    # Google Model Configurations - UPGRADED TO 3.1 (Expert Image + Pro Brain)
    GOOGLE_LLM = os.getenv("GOOGLE_LLM", "gemini-3.1-pro-preview")
    GOOGLE_LLM_IMAGE = os.getenv("GOOGLE_LLM_IMAGE", "gemini-3.1-flash-image-preview")
